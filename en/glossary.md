...
**AI Agent** — A configured AI assistant combining an AI Adapter with a defined role, goal, and backstory, plus optional tools. Invoked from Workflows. See [How to Set Up an AI Agent](#ai-agents).
