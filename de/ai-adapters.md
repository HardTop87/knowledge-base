...
1. Wechseln Sie zu **Menu → AI & ML → AI Adapters**
2. Klicken Sie auf **+ New Adapter**
3. Wählen Sie den **Type**
4. Vergeben Sie einen **Name** (z.B. `Claude Sonnet - Production`)
5. Tragen Sie die nötigen Zugangsdaten ein:
