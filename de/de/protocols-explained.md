...
HTTP verbindet Systeme, die über Standard-Web-Requests kommunizieren. Nutze HTTP für die Anbindung von MIS, Auftragsmanagement oder jeder Software, die REST-Calls sendet oder empfängt.
...
Die SQL-Integration verbindet CoCoCo mit externen Datenbanken: ERP-Systeme, Legacy-Plattformen oder jede SQL-kompatible Datenquelle. Nutze sie in Workflows, um als Reaktion auf Produktionsereignisse Datensätze abzufragen oder zu aktualisieren.
