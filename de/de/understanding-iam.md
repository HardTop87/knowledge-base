...
3. Vergib **Name** und **Description**
4. Klicke auf **+ Add Statement**
5. Setze den **Effect** auf `ALLOW` oder `DENY`
6. Suchen und wähle die gewünschten **Actions**
7. Klicke auf **Save**
...
Wenn mehrere User die gleichen Berechtigungen brauchen, nutze Teams statt jeden User einzeln zu berechtigen. Siehe: [Ein Team anlegen](#create-team)
