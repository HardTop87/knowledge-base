...
1. Füge im Workflow-Editor an der gewünschten Stelle eine **Task** Node ein
2. Konfiguriere die Task:
...
3. Verbinde den Output der Node mit den Schritten, die nach der Freigabe laufen sollen
