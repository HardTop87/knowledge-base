...
Jedes Mal, wenn du eine Custom App veröffentlichst, speichert CoCoCo einen unveränderlichen Versionsstand mit Template, Script und Server API zu diesem Zeitpunkt.

## Versionshistorie ansehen

1. Öffne die Custom App im Editor
2. Klicke oben auf **Versions**
...
Der Editor arbeitet immer auf der **Arbeitsversion**. Einem Entwurf, der für User nicht sichtbar ist, bis du veröffentlichst. Jede Veröffentlichung erzeugt einen neuen Versionsstand.