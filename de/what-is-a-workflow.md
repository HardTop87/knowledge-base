...
**Trigger**: Das Ereignis, das den Workflow startet. Jeder Workflow hat genau einen Trigger. Die Trigger-Typen finden Sie unter [Einen Workflow anlegen](#create-workflow).
